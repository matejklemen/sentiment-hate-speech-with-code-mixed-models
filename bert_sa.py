...
test = pd.read_csv('datasets/Final_datasets/Hindi_SA_test100.csv')
...
# test = pd.read_csv('datasets/Final_datasets/Russian_SA_test50.csv')
...
out_dir = './models/hindi_models/mbert'
